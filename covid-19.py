...
def start(message):
	...
	messageText = f"<b>Ողջույն {message.from_user.first_name}!</b><br> Կորոնավիրուսի մասին վերջին տվյալները ստանալու համար ուղարկեք երկրի անունը (լատինատառերով)" \
		f"Օրինակ։ Armenia, Russia, Italy, Iran և այլն"
